...
import io.github.jmecn.tiled.render.HexagonalRenderer;
import io.github.jmecn.tiled.render.IsometricRenderer;
...
public class TiledMapAppState extends BaseAppState implements AnalogListener, ActionListener {
    ...
    private void applyParallax(Layer layer, Vector2f distance) {
        ...
        if (layer instanceof GroupLayer) {
            ...
            float z = layer.getVisual().getLocalTranslation().y;
            layer.getVisual().setLocalTranslation(x, z, y);
        }
    }
