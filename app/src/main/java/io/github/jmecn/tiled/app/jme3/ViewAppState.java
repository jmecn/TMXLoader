...
/**
 * ViewAppState manage a {@link MapRenderer} for {@link TiledMap} and render it.
 * 
 * @author yanmaoyuan
 */
public class ViewAppState extends BaseAppState implements AnalogListener, ActionListener {

    static Logger logger = LoggerFactory.getLogger(ViewAppState.class);
    ...
    public void setMap(TiledMap map) {
        if (!isInitialized()) {
            throw new IllegalStateException("ViewAppState is not initialized.");
        }
        if (map == null) {
            return;
        }
