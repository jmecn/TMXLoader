...
public class Polygon implements Shape2D {
	 ...
	 * 
	 * @param vertices
	 *            an array where every even element represents the horizontal
	...
	/**
	 * Calculates and returns the vertices of the polygon after scaling,
	 * rotation, and positional translations have been applied, as they are
	...
	public float[] getTransformedVertices() {
		...
		final float radian = rotation * FastMath.DEG_TO_RAD;
		final float cos = FastMath.cos(radian);
		final float sin = FastMath.sin(radian);
	...
	/**
	 * Sets the polygon's local vertices relative to the origin point, without
	 * any scaling, rotating or translations being applied.
	 * 
	 * @param vertices
	 *            float array where every even element represents the
	...
	/**
	 * Translates the polygon's position by the specified horizontal and
	 * vertical amounts.
	 */
