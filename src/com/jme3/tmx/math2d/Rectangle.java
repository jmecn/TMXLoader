...
public class Rectangle implements Shape2D {
	...
	/** return the Vector2f with coordinates of this rectangle
	 * @param position The Vector2f */
	...
	/** @return the Vector2f with size of this rectangle
	 * @param size The Vector2f */
	 ...
	 * @return this rectangle for chaining */
	public Rectangle merge (Vector2f vec) {
	 ...
	 * @return this rectangle for chaining */
	public Rectangle merge (Vector2f[] vecs) {
		float minX = x;
		float maxX = x + width;
		float minY = y;
		float maxY = y + height;
	...
	/** Calculates the center of the rectangle. Results are located in the given Vector2f
	 * @param vector the Vector2f to use
	 * @return the given vector with results stored inside */
	public Vector2f getCenter (Vector2f vector) {
		vector.x = x + width / 2;
		vector.y = y + height / 2;
		return vector;
	}
	 ...
	 * @return this for chaining */
	public Rectangle setCenter (Vector2f position) {
	...
	public boolean equals (Object obj) {
		...
		if (Float.floatToRawIntBits(y) != Float.floatToRawIntBits(other.y)) return false;
		return true;
	}
